...
buffer = RolloutBuffer(512, 256,2,4)
...
while total_timesteps < N_TIMESTEPS:
    ...
    while iteration_timesteps < N_ITERATION_TIMESTEPS:
        ...
        buffer.add(state[0].clone().detach().cpu().numpy(), action, reward, done, log_prob)
