...
df = pd.read_csv("./results/ccar_no_norm/result.csv")
x1 = df.values[:,1]
y1 = df.values[:,2]
df = pd.read_csv("./results/ccar_no_norm_e1/result.csv")
x2 = df.values[:,1]
y2 = df.values[:,2]
df = pd.read_csv("./results/ccar_no_norm_e2/result.csv")
x3 = df.values[:,1]
y3 = df.values[:,2]
df = pd.read_csv("./results/ccar_no_norm_e3/result.csv")
x4 = df.values[:,1]
y4 = df.values[:,2]
df = pd.read_csv("./results/ccar_no_norm_e4/result.csv")
x5 = df.values[:,1]
y5 = df.values[:,2]
...
plt.plot(x4, y4, label="0.1")
plt.plot(x5, y5, label="1")
plt.legend()
# plt.fill_between(x,y_min, y_max)
plt.show()
plt.plot(x1, y1_smooth, label="0.0")
plt.plot(x2, y2_smooth, label="0.001")
plt.plot(x3, y3_smooth, label="0.01")
plt.plot(x4, y4_smooth, label="0.1")
plt.plot(x5, y5_smooth, label="1")
plt.legend()
# plt.fill_between(x,y_min, y_max)
plt.show()